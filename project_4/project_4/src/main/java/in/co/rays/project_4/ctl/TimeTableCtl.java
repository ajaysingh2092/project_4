	 ...
	 if(OP_SAVE.equalsIgnoreCase(op)||OP_UPDATE.equalsIgnoreCase(op)){
		 ...
		 try{
			 if(id>0){
				 ...
				 System.out.println("courseN  "+bean.getCourseName());
				 System.out.println("subject  "+bean.getSubId());
				 System.out.println("subjectN  "+bean.getSubName());
				 System.out.println("semester  "+bean.getSemester());
				 System.out.println("examdate  "+bean.getExamDate());
				 System.out.println("examtime  "+bean.getExamTime());
