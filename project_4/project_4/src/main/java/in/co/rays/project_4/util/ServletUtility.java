...
/**
 * provide servlet utility operation for Servlet utility container
 * @author ajay
 *
 */
...
*/
    ...
    public static int getPageNo(HttpServletRequest request) {
    	...
    	return a; //DataUtility.getInt((String)request.getAttribute("pageNo"));//(int) request.getAttribute("pageNo");
    }
