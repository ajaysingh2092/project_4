...
public class EmailMessage {
   ...
   /**
    ...
    public void setTo(String to) {
    	System.out.println("email message class of utility setTo method");
	        this.to = to;
	    }
    ...
    public void setFrom(String from) {
    	System.out.println("email message class of utility setFrom method");
	        this.from = from;
	    }
    ...
    public String getMessage() {
    	System.out.println("email message class of utility get message method");
	        return message;
	    }
