 ...
 * Generated at: 2020-10-13 11:36:29 UTC
...
import in.co.rays.project_4.ctl.UserListCtl;
...
public final class UserListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("in.co.rays.project_4.ctl.UserListCtl");
...
return;
    ...
    try {
      ...
      out.write("<title>UserListView</title>\r\n");
    ...
    if (userLoggedIn) {
      ...
      out.write('\r');
      out.write('\n');
      in.co.rays.project_4.bean.UserBean bean1 = null;
      bean1 = (in.co.rays.project_4.bean.UserBean) _jspx_page_context.getAttribute("bean1", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (bean1 == null){
        bean1 = new in.co.rays.project_4.bean.UserBean();
      ...
      out.write("<h1 style=\"font-size: 40px;\">User List</h1>\r\n");
      out.write("\t\t\t<center>\r\n");
      ...
      out.write("<tr>\r\n");
      out.write("  <td align=\"center\"><label>FirstName:</label>\r\n");
      ...
      out.write("\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t&emsp;<label>LoginId</label>\r\n");
      out.write("\t<input type=\"text\" name=\"login\" placeholder=\"Enter LoginId\" \r\n");
      out.write("\tvalue=\"");
      out.print(ServletUtility.getParameter("login",request));
      out.write("\">\r\n");
      out.write("\t&emsp;<label class=\"p1\">Role</label>&emsp;");
      out.print(HTMLUtility.getList("roleId", String.valueOf(bean.getRoleId()), list1));
      out.write("\r\n");
...
if (bean.getRoleId() == RoleBean.ADMIN) {
      ...
      out.print(date);
      out.write("</td>\r\n");
      out.write("    <td align=\"center\"><a href=\"UserCtl?id=");
      out.print(bean.getId());
      out.write('"');
if (bean.getRoleId() == RoleBean.ADMIN) {
      out.write("\r\n");
      ...
      out.write("<table width=\"100%\">\r\n");
      out.write("<tr>\r\n");
      out.write("  <td><input type=\"submit\" name=\"operation\" style=\"padding: 5px;\"\r\n");
      out.write("  value=\"");
      out.print(UserListCtl.OP_PREVIOUS);
      out.write('"');
      out.print(pageNo > 1 ? "" : "disabled");
      out.write("></td>\r\n");
      out.write("  <td><input type=\"submit\" name=\"operation\" style=\"padding: 5px;\" class=\"button1\"\r\n");
