 ...
 * Generated at: 2020-10-28 03:26:07 UTC
...
return;
    ...
    if (userLoggedIn) {
      ...
      out.write("\t\t\t<table>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td><label class=\"p1\">College Name</label> \r\n");
      out.write("\t\t\t\t\t");
      out.print( HTMLUtility.getList("name" , String.valueOf(bean.getId()), list1) );
      out.write("&emsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<label class=\"p1\">City</label> <input type=\"text\" name=\"city\" class=\"p2\"\r\n");
      out.write("\t\t\t\t\t\tvalue=\"");
      out.print(ServletUtility.getParameter("city", request));
      out.write("\">&emsp;&emsp;\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<label class=\"p1\">State</label> <input type=\"text\" name=\"state\" class=\"p2\"\r\n");
      out.write("\t\t\t\t\t\tvalue=\"");
